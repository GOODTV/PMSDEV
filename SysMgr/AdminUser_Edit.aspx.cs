...
public partial class SysMgr_AdminUser_Edit : BasePage 
{
    ...
    {
        Session["ProgID"] = "MENU_SYSTEM_USER";
        //權控處理
        AuthrityControl();
    ...
    public void LoadFormData()
    {
        ...
        //建檔日期
        txtCreateDate.Text = Util.DateTime2String(dr["CreateDate"], DateType.yyyyMMdd, EmptyType.ReturnEmpty);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        if (txtPassword.Text == txtRePassword.Text)
        {
            if (txtPwdValidDate.Text == "" || Convert.ToDateTime(txtPwdValidDate.Text) >= System.DateTime.Now)
            {
                ...
                dict.Add("CreateDate", txtCreateDate.Text);
