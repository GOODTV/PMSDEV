<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminUser_Edit.aspx.cs" Inherits="SysMgr_AdminUser_Edit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //          var PersonProfile_Uid = document.getElementById('HFD_Uid').value;
        //          window.open('../Common/UpLoad.aspx?PersonProfile_Uid=' + PersonProfile_Uid + '&Ap_Name=' + Ap_Name + '&AllowType=img', 'upload', 'scrollbars=no,status=no,toolbar=no,top=100,left=120,width=560,height=120');
        //      }
    </script>
</head>
<body class="body">
    ...
    <table class="table-detail" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPwdValidDate" onchange="CheckDateFormat(this, '密碼最後有效日期');" CssClass="font9" Width="18mm" runat="server" ></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCreateDate" onchange="CheckDateFormat(this, '建檔日期');" CssClass="font9" Width="18mm" runat="server" ></asp:TextBox>
