...
public partial class SysMgr_AdminRight : BasePage
{
    ...
    public void LoadDropDownListData()
    {
        ...
        Util.FillDropDownList(ddlGroup, strSql, "GroupName", "uid", false);
    ...
    private string GetTitle()
    {
        ...
        //string strFontSize = "12px";    //"14px"
        string strWidth = "55px";   //"45px"
        ...
        strTemp += "<input type='button' id='btnSave' value='存檔' Class='ui-button ui-corner-all' onclick='SaveAllValue()' style='height:27px;' />";
        cell.InnerHtml = strTemp == "" ? "&nbsp" : strTemp;
        css = cell.Style;
        ...
        list.Add(new ControlData("Label", "初審"));
        strTemp = HtmlUtil.RenderControl(list);
        cell.InnerHtml = strTemp == "" ? "&nbsp" : strTemp;
        css = cell.Style;
        css.Add("text-align", "center");
        ...
        list.Add(new ControlData("Label", "覆審"));
        strTemp = HtmlUtil.RenderControl(list);
        cell.InnerHtml = strTemp == "" ? "&nbsp" : strTemp;
        css = cell.Style;
        css.Add("text-align", "center");
        ...
        cell = new HtmlTableCell();
        list.Clear();
        list.Add(new ControlData("Checkbox", "GN_Examine4ColAll", "CB_Examine4ColAll", "Examine4ColAll", "", true, strDefaultValue));
        list.Add(new ControlData("Label", "核決"));
        strTemp = HtmlUtil.RenderControl(list);
        cell.InnerHtml = strTemp == "" ? "&nbsp" : strTemp;
        css = cell.Style;
        css.Add("text-align", "center");
    ...
    private string GetBody()
    {
        ...
        for (int i = 0; i < menuList.Count; i++)
        {
            ...
            bool bExamine1 = false, bExamine2 = false, bExamine3 = false, bExamine4 = false;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                bExamine2 = dt.Rows[0]["_ReExamine1"].ToString() == "True" ? true : false;
                bExamine3 = dt.Rows[0]["_ReExamine2"].ToString() == "True" ? true : false;
                bExamine4 = dt.Rows[0]["_Approve"].ToString() == "True" ? true : false;
            }
            ...
            cell = new HtmlTableCell();
            list.Clear();
            list.Add(new ControlData("Checkbox", "GN_Examine4", "CB_ColExamine4" + i.ToString(), i.ToString(), "", false, null));
            list[0].Checked = bExamine4;
            strTemp = HtmlUtil.RenderControl(list);
            cell.InnerHtml = strTemp == "" ? "&nbsp" : strTemp;
            css = cell.Style;
            css.Add("text-align", "center");
    ...
    private void SaveData()
    {
        ...
        for (int i = 0; i < SetupValues.Length; i++)
        {
            ...
            if (NpoDB.GetDataTableS(strSql, dict).Rows.Count == 0)
            {
                ...
                strSql += "( MenuID, GroupID, _AddNew, _Update, _Delete, _Query, _Print, _Focus, _Examine, _ReExamine1, _ReExamine2, _Approve,  UpdateDate) values";
                strSql += "(@MenuID,@GroupID,@_AddNew,@_Update,@_Delete,@_Query,@_Print,@_Focus,@_Examine,@_ReExamine1,@_ReExamine2,@_Approve, getdate()) ";
            }
            else
            {
                ...
                strSql += ", _ReExamine1=@_ReExamine1";
                strSql += ", _ReExamine2=@_ReExamine2";
            ...
            dict.Add("_ReExamine1", SetupValue[8]);
            dict.Add("_ReExamine2", SetupValue[9]);
            dict.Add("_Approve", SetupValue[10]);
