...
namespace Core.DataAccess
{
    public class SrtmcsEpgDao
    {
        ...
        public String GetEpgoList(string startDate, string endDate, string channel, string planningTitle, string episodeNumber, string houseNo, string premier)
        {
            ...
            strSQL.Append(" SELECT EPG.* ,SRT.[ModifiedDatetime],SRT.[Subtitle],SRT.[SubtitleSRT] ");
            ...
            strSQL.Append(" ON SRT.[ProgramID] = EPG.PlanningTitleID AND SRT.[Episode] = EPG.EpisodeNumber ");
        ...
        public String GetSrtExportList()
        {
            ...
            strSQL.Append(" SELECT EPG.HouseNo ,ST.SubtitleSRT ");
            ...
            strSQL.Append(" ON ST.ProgramID = EPG.PlanningTitle AND ST._ST031 = EPG.EpisodeNumber ");
            strSQL.Append(" WHERE ST.SubtitleSRT IS NOT NULL ");
