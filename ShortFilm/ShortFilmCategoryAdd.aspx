<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShortFilmCategoryAdd.aspx.cs" Inherits="ShortFilm_ShortFilmCategoryAdd" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table-detail"> 
            ...
            <tr>
                <td align="right" colspan="2">
                    ...
                    <asp:Button ID="btnExit" runat="server" class="ui-button ui-corner-all" Width="20mm" Text="取消" onclick="btnExit_Click"/>
                </td>
            </tr>
        </table>
    </div>
