<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadCUE.aspx.cs" Inherits="UploadCUE" %>
     ...
     <script type="text/javascript">
         ...
         function validate(elem) {
             ...
             if (extIndex != -1)
                 ...
                 var name = str;
             if (name.substr(0, 3).toLowerCase() == "cue") {
                 return true;
             } else {
                 alert("所選擇的檔案不是CUE格式的檔案");
                 elem.focus();
                 return false;
             }
    ...
    <asp:Table ID="Table1" runat="server" Width="100%">
        <asp:TableRow>
            ...
            <asp:TableCell Width="92%" HorizontalAlign = "Left">                        
                ...
                <asp:Button ID="btnQueryCUE" runat="server" Text="CUE查詢" OnClick="btnQueryCUE_Click" CssClass="Button" />                                                                                        
            </asp:TableCell>            
        </asp:TableRow>        
    </asp:Table>                 
    </form>
