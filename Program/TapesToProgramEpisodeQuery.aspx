<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TapesToProgramEpisodeQuery.aspx.cs" Inherits="View_TapesToProgramEpisodeQuery" %>
...
<body>
    <form id="form1" runat="server">        
        ...
        <asp:Panel ID="divQuery" runat="server">
            <table width="500px" style="background-color: #FFFFCC">
                <tr align="left">
                    <td width="90">
