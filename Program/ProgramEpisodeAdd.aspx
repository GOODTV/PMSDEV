<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProgramEpisodeAdd.aspx.cs" Inherits="View_ProgramEpisodeAdd" %>
    ...
    <div>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table-detail"> 
            <tr style="HEIGHT: 25px">
               <td style="text-align: left; background-color: #5EABDB; color: #FFFFFF;" colspan="5">分集內容編輯</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" colspan="2" class="style1">
                    <asp:TextBox runat="server" ID="txtOriginal_ProgramCode" CssClass="font9" Width="100px"></asp:TextBox>
                </td>
                <th align="right" colspan="1">
                    原集數：
                </th>
                <td align="left" colspan="2" class="style1">
                    <asp:TextBox runat="server" ID="txtOriginal_Episode" CssClass="font9" Width="70px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th align="right" colspan="1">
            ...
            <tr>
                ...
                <td align="left" colspan="5" class="style1">
                    <asp:TextBox runat="server" ID="txtTotalLength" CssClass="font9" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th align="right" colspan="1">
            ...
            <tr>
                ...
                <td align="left" colspan="5" class="style1">
                    ...
                    <img id="imgPremiereDate" alt="" src="../img/date.gif" />
                </td>
