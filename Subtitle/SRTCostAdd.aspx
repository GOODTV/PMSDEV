<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SRTCostAdd.aspx.cs" Inherits="View_SRTCostAdd" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table-detail"> 
            ...
            <tr>
                ...
                <td align="left" colspan="2" class="style1">
                    <asp:TextBox ID="tbxCostEffectiveDate" runat="server" onchange="CheckDateFormat(this, '成本生效日期');" Width="100px"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left" colspan="2" class="style1">
                    <asp:dropdownlist runat="server" ID="ddlMake_Category"></asp:dropdownlist>
                </td>
            </tr>
            <tr>
                ...
                <td align="left" colspan="2" class="style1">
                    <asp:TextBox runat="server" ID="tbxLength" Width="100px" Text="0"></asp:TextBox>分鐘
                </td>
            </tr>
            <tr>
                ...
                <td align="left" colspan="5" class="style1">
                    <asp:TextBox runat="server" ID="tbxAmount" Width="100px" Text="0"></asp:TextBox>元
                </td>
            </tr>
            <tr>
                <td align="right">說明
