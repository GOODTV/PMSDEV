<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SRTPersonnelEdit.aspx.cs" Inherits="View_SRTPersonnelEdit" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table-detail"> 
            ...
            <tr>
                ...
                <td align="left" colspan="2" class="style1">
                    <asp:TextBox runat="server" ID="tbxEditorID" Width="100px" BackColor="#E6E6FA" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
